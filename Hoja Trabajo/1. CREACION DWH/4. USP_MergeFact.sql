...
BEGIN
	...
	BEGIN TRY
		...
		INSERT (SK_Partes, SK_Geografia, SK_Clientes, DateKey, ID_Orden, ID_Descuento, ID_DetalleOrden, NombreDescuento, PorcentajeDescuento, Total_Orden, Cantidad, NombreStatus, Fecha_Orden, FechaCreacion, UsuarioCreacion, FechaModificacion, UsuarioModificacion, ID_Batch, ID_SourceSystem)
		VALUES (S.SK_Partes, S.SK_Geografia, S.SK_Clientes, S.DateKey, S.ID_Orden, S.ID_Descuento, S.ID_DetalleOrden, S.NombreDescuento, S.PorcentajeDescuento, S.Total_Orden, S.Cantidad, S.NombreStatus,S.Fecha_Orden, S.FechaCreacion, S.UsuarioCreacion,S.FechaModificacion, S.UsuarioModificacion, S.ID_Batch, S.ID_SourceSystem);
